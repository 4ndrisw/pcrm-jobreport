...
class Jobreport_pdf extends App_pdf
{
    protected $jobreport;
    ...
    {
        $customPath = APPPATH . 'views/themes/' . active_clients_theme() . '/views/my_jobreportpdf.php';
        $actualPath = module_views_path('jobreports','themes/' . active_clients_theme() . '/views/jobreports/jobreportpdf.php');
