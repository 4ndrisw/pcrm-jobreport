         ...
         <div class="col-md-6">
            <div class="f_client_id">
             <div class="form-group select-placeholder">
               ...
               <?php $selected = (isset($jobreport) ? $jobreport->clientid : $project_data->client_data->userid);
                 if($selected == ''){
            ...
            <div class="form-group projects-wrapper<?php if((!isset($jobreport)) || (isset($jobreport) && !customer_has_projects($jobreport->clientid))){ echo ' hide';} ?>">
            ...
            <?php $last_jobreport_number = $_jobreport_number + 2; ?>
            <div class="form-group">
               <label for="number"><?php echo _l('jobreport_add_edit_number'); ?></label>
               <div class="input-group">
                  <span class="input-group-addon">
                  ...
                  <input type="text" name="number" class="form-control" value="<?php echo $last_jobreport_number; ?>" data-isedit="<?php echo $isedit; ?>" data-original-number="<?php echo $data_original_number; ?>">
                  <?php if($format == 3) { ?>
                  <span class="input-group-addon">
                     <span id="prefix_year" class="format-n-yy"><?php echo $yy; ?></span>
                  </span>
