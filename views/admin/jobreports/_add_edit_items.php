...
<div class="panel-body mtop10">
   ...
   <div class="table-responsive s_table">
      <table class="table jobreport-items-table items table-main-jobreport-edit has-calculations no-mtop">
         <thead>
            <tr>
               <th></th>
               <th width="30%" align="left"><i class="fa fa-exclamation-circle" aria-hidden="true" data-toggle="tooltip" data-title="<?php echo _l('item_description_new_lines_notice'); ?>"></i> <?php echo _l('jobreport_table_item_heading'); ?></th>
               <th width="45%" align="left"><?php echo _l('jobreport_table_item_description'); ?></th>
               <?php
                  ...
                  $qty_heading = _l('jobreport_table_quantity_heading');
                  if(isset($jobreport) && $jobreport->show_quantity_as == 2){
                  $qty_heading = _l('jobreport_table_hours_heading');
                  } else if(isset($jobreport) && $jobreport->show_quantity_as == 3){
                  $qty_heading = _l('jobreport_table_quantity_heading') . '/' . _l('jobreport_table_hours_heading');
                  }
                  ?>
            ...
            <tr class="main">
               ...
               <td>
                  <?php
                     ...
                     ?>
                  <button type="button" onclick="add_jobreport_item_to_table('undefined','undefined',<?php echo $new_item; ?>); return false;" class="btn text-center btn-info"><i class="fa fa-check"></i></button>
               </td>
            </tr>
            <?php if (isset($jobreport) || isset($add_items)) {
               $i               = 1;
               $items_indicator = 'newitems';
               if (isset($jobreport)) {
                 $add_items       = $jobreport->items;
