...
<div class="widget" id="widget-<?php echo create_widget_id(); ?>" data-name="<?php echo _l('jobreport_unfinished_project'); ?>">
    <?php if(staff_can('view', 'jobreports') || staff_can('view_own', 'jobreports')) { ?>
    <div class="panel_s jobreports-expiring">
        <div class="panel-body padding-10">
            <p class="padding-5"><?php echo _l('jobreport_unfinished_project'); ?></p>
            ...
            <?php } else { ?>
                <div class="text-center padding-5">
                    ...
                    <h4><?php echo _l('no_jobreport_unfinished_project',["7"]) ; ?> </h4>
                </div>
            <?php } ?>
        </div>
    </div>
